...
/* ── live writing counter ── */
function WritingCounter() {
  const [seconds, setSeconds] = useState(0)

  useEffect(() => {
    const base = 63072000 + Math.floor(Math.random() * 1000000)
    setSeconds(base)
...
/* ── stat block ── */
const STATS = [
  { label: "POSTS_WRITTEN", value: "128" },
  { label: "YEARS_CODING", value: "9" },
  { label: "OSS_PROJECTS", value: "23" },
  { label: "COFFEE_CUPS", value: "∞" },
]
      ...
      <div className="flex flex-col lg:flex-row gap-0 border-2 border-foreground">
        ...
        >
          ...
          <Image
            ...
            alt="等距视角的开发者工作台，包含机械键盘、显示器和咖啡杯"
            fill
        ...
        >
          ...
          <div className="flex items-center justify-between px-5 py-3 border-b-2 border-foreground">
            ...
            <span className="text-[10px] tracking-[0.2em] uppercase text-muted-foreground font-mono">v3.1.0</span>
          </div>
          ...
          <div className="flex-1 flex flex-col justify-between px-5 py-6 lg:py-8">
            <div className="flex flex-col gap-6">
              ...
              >
                写代码，也 <span className="text-[#ea580c]">写下过程</span>
              </motion.h2>
              ...
              >
                <p className="text-xs lg:text-sm font-mono text-muted-foreground leading-relaxed">
                  我是花海，一名软件工程师。白天做分布式系统，晚上把踩过的坑、验证过的方案写成笔记。相信文字比记忆更可靠。
                </p>
                <p className="text-xs lg:text-sm font-mono text-muted-foreground leading-relaxed">
                  这个博客没有算法推荐，没有弹窗订阅框轰炸。只有干净的排版、可复现的实验，和偶尔的碎碎念。欢迎通过邮件和我交流。
                </p>
              </motion.div>
